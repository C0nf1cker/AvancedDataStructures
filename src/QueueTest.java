...
class QueueTest {
    ...
    void testResize() {
        ...
        Assumptions.assumeTrue(queue instanceof /*ArrayQueue*/LinkedQueue, "Not an instance of ArrayQueue");

        //assumingThat if a test tha only executes in certain conditions
        //if the condition is not met the test will pass.
        Assumptions.assumingThat(queue instanceof /*ArrayQueue*/LinkedQueue,
                ()->{
                    int start = 100;
                    int maxElements = 500;
